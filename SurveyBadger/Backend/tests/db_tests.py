...
class DatabaseTestCase(unittest.TestCase):
    ...
    def loadTestData(self):
        self.db.insert("users",{"Name" : "testuc","Email" : "uc@qut.edu.au","Type" : "UC","Units" : "CAB202"})
        self.db.insert("users",{"Name" : "testtutor","Email" : "tutor@qut.edu.au","Type" : "Tutor","Units" : "CAB201"})
        self.db.insert("users",{"Name" : "nTESTUSR","Email" : "student@qut.edu.au","Type" : "Student","Units" : "CAB201,CAB202"})
    ...
    def test_insert_users(self):
        self.db.insert("users",{"Name" : "testuser","Email" : "email@qut.edu.au","Type" : "Tutor","Units" : "CAB201"})
